...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/e87dd230e37d4338aa995907517e811c
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    'e87dd230e37d4338aa995907517e811c,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '软件，游戏，影视，破解，VPN，梯子，翻墙', // 网站关键词 英文逗号隔开
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '', // 你的代码仓库名， 例如我是 'ddwhite01/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '', // 你的Github仓库名 e.g 'ddwhite01/NotionNext'
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || '', // 你的Github仓库名，例如 'ddwhite01'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || '', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '', // 管理员用户名、一般是自己 e.g 'ddwhite01'
